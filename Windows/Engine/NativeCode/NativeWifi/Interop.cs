...
namespace Org.InCommon.InCert.Engine.NativeCode.NativeWifi
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is intended for internal use. Use the <see>
    ///                                                      <cref>WlanCliient</cref>
    ///                                                  </see>
    ///     class instead.
    /// </remarks>
    public static class NativeMethods
    {
        ...
        public struct WlanAvailableNetwork
        {
            ...
            /// When this member is set to <c>true</c>, an application must call <see>
            ///                                                                      <cref>WlanClient.WlanInterface.GetNetworkBssList</cref>
            ///                                                                  </see>
            ///     to get the complete list of PHY types.
        ...
        public struct WlanConnectionParameters
        {
            ...
            /// <summary>
            /// Pointer to a <see>
            ///                  <cref>Dot11BssidList</cref>
            ///              </see>
            ///     structure that contains the list of basic service set (BSS) identifiers desired for the connection.
            /// </summary>
            /// <remarks>
        ...
        public class WlanException : Exception
        {
            ...
            public override string Message
            {
                get
                {
                    ...
                    return WlanReasonCodeToString(reasonCode, sb.Capacity, sb, IntPtr.Zero) == 0 ? sb.ToString() : string.Empty;
                }
            }
        }
