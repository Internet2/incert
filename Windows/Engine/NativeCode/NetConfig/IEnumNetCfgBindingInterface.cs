...
namespace Org.InCommon.InCert.Engine.NativeCode.NetConfig
{
    ...
    [Guid("C0E8AE90-306E-11D1-AACF-00805FC1270E"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    [ComVisible(true)]
    public interface IEnumNetCfgBindingInterface
    {
        ...
        int Reset();
        int Clone([Out, MarshalAs(UnmanagedType.IUnknown)] out /*IEnumNetCfgBindingInterface*/object ppenum);
    }
}