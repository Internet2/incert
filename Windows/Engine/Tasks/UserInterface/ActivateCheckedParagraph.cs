...
{
    class ActivateCheckedParagraph : AbstractTask
    {
        ...
        public ActivateCheckedParagraph(
            IEngine engine):
            base(engine)
        {
        ...
        public override IResult Execute(IResult previousResults)
        {
            try
            {
                ...
                model.State = CheckedParagraphModel.CheckedParagraphState.Active;
        ...
        {
            return "Activate checked paragraph";
        }
    }
}
