...
{
    class RemoveCheckedParagraphSubtitle : AbstractTask
    {
        ...
        public RemoveCheckedParagraphSubtitle(IEngine engine)
            : base(engine)
        {
        }
        ...
        {
            return "Remove paragraph subtitle";
        }
    }
}
